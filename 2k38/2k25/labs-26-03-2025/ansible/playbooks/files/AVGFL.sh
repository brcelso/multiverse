...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=114266 -o /tmp/$package $CURLOPTIONS
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:87CFC383-9160-5863-F921-024B396843AE" "token:0B8FCEC6-6334-9356-7599-AF935A465401" "policyid:628" "groupid:1222"
# /opt/ds_agent/dsa_control -a dsm://agents.deepsecurity.trendmicro.com:443/ "tenantID:87CFC383-9160-5863-F921-024B396843AE" "token:0B8FCEC6-6334-9356-7599-AF935A465401" "policyid:628" "groupid:1222"