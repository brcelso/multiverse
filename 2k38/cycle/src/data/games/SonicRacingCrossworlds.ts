export const sonicracing = {
  ...
  Brazil: {
    'October 2025': [
      { edition: 'Deluxe Edition', price: 320.90, discount: 37, currency: 'R$', exchangeTax: 3.56 },
      { edition: 'Standard Edition', price: 219.90, discount: 45, currency: 'R$', exchangeTax: 3.14 },
    ],
    'September 2025': [
