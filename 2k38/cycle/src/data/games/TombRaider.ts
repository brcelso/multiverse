export const tombRaider = {
  ...
  Brazil: {
    ...
    'January 2014': [
      { edition: 'Definitive Edition', price: 19.9, currency: 'R$', discount: 89 },
      { edition: 'Definitive Edition', price: 99.5, currency: 'R$', discount: 45 },
      { edition: 'Definitive Edition PS4', price: 179.99, currency: 'R$' },
  ...
  UnitedStates: {
    ...
    'December 2015': [
      { edition: 'Definitive Edition', price: 2.99, currency: '$', discount: 95 },
    ],
    'June 2018': [
      { edition: 'Definitive Edition', price: 2.99, currency: '$', discount: 95 },
    ],
