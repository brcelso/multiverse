export const finalFantasyXVI = {
  ...
  Brazil: {
    ...
    'January 2025': [
      { edition: 'Complete Edition', price: 262.42, currency: 'R$', discount: 25 },
      { edition: 'Standard Edition', price: 187.12, currency: 'R$', discount: 25 },
    ],
    'June 2023': [
      { edition: 'Complete Edition', price: 349.9, currency: 'R$' },
  ...
  Europe: {
    ...
    'January 2025': [
      { edition: 'Complete Edition', price: 59.99, currency: '€', discount: 25 },
      { edition: 'Standard Edition', price: 44.99, currency: '€', discount: 25 },
    ],
    'June 2023': [
      { edition: 'Complete Edition', price: 79.99, currency: '€' },
