export const silenthillf = {
  ...
  Brazil: {
    ...
    'June 2025': [
      { edition: "Deluxe Edition", price: 455.90, increase: 14, currency: 'R$', exchangeTax: 5.69 },
      { edition: "Standard Edition", price: 399.50, increase: 14, currency: 'R$', exchangeTax: 5.70 },
