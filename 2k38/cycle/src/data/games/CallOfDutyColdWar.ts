export const codcoldwar = {
  ...
  Brazil: {
    'June 2025': [
      ...
      { edition: 'Standard', price: 90.42, discount: 67, currency: 'R$', exchangeTax: 4.56 },
    ],
    'April 2025': [
      { edition: 'Cross-Gen', price: 319.90, currency: 'R$', exchangeTax: 4.57 },
  ...
  Europe: {
    ...
    'April 2025': [
      { edition: 'Cross-Gen', price: 79.99, currency: '€' },
  ...
  UnitedKingdom: {
    'June 2025': [
      ...
      { edition: 'Standard', price: 16.49, discount: 67, currency: '£' },
    ],
    'April 2025': [
